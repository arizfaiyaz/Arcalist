          ...
          bookmarks: [
            {
              ...
              favicon: favicon("chat.openai.com"),
              createdAt: Date.now(),
            },
            {
              id: "bm-2",
